...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/devalue/index.js';
import destr from 'file://E:/Projects/Nuxt/leader-movie/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Projects/Nuxt/leader-movie/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://E:/Projects/Nuxt/leader-movie/node_modules/vue/index.mjs';
import { isVNode, version, unref } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/Projects/Nuxt/leader-movie/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "E:/Projects/Nuxt/leader-movie/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"E:/Projects/Nuxt/leader-movie/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Projects\\Nuxt\\leader-movie","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Projects\\Nuxt\\leader-movie\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Projects\\Nuxt\\leader-movie\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Projects\\Nuxt\\leader-movie\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Projects\\Nuxt\\leader-movie\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _UGb5gZAgYf = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/Projects/Nuxt/leader-movie";
...
const _SOLdbKsl14 = defineNitroPlugin(async (nitroApp) => {
...
const _ifx8YK = lazyEventHandler(() => {
...
const _lazy_YDCziB = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_YDCziB, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _ifx8YK, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YDCziB, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://E:/Projects/Nuxt/leader-movie/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/Projects/Nuxt/leader-movie/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
